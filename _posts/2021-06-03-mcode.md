...
<figure style="margin-bottom: 1em; margin-top: 1em;">
 <img src="{{ site.url }}/img/posts/mcode-introduction/mcode_conceptual_framework.png"
...
<figure style="margin-bottom: 1em; margin-top: 1em;">
 <img src="{{ site.url }}/img/posts/mcode-introduction/mcode_disease_domain_profiles.jpg"
 width="95%" style="margin: 10px 10px 10px 10px;">
